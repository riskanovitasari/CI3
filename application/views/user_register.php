		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					...
					<div class="form-group">
						<label>Kodepos</label>
						<input type="text" class="form-control" name="kode_pos" placeholder="Kodepos">
					</div>
					<div class="form-group">
						<label>Email</label>
					...
					<div class="form-group">
					    ...
					    <input class="form-check-input" type="radio" name="manager" id="reseller" value="2" checked>
					    <label class="form-check-label" for="reseller">Reseller</label>
					 </div>
					 <div class="form-check">
				        <input class="form-check-input" type="radio" name="manager" id="customer" value="3">
				        <label class="form-check-label" for="reseller">Reseller</label>
					    </div>
					</div>
